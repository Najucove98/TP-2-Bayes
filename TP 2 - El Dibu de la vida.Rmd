...
```{r ,echo=FALSE, fig.align = "center", fig.width = 4, fig.height = 2.8, warning=FALSE, fig.cap=c("(\\#fig:grafico1) Gráfico de dispersión", "(\\#fig:grafico2) Histograma de mpg"),fig.show='hold', out.width='50%'}
