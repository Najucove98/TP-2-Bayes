...
paso 1) transformar los parametros tal que su dominio sea R\^p paso 2)
tener posterior no normalizado de $\theta^*$ donde
$\theta^* = {\mu, \sigma^*}$ $\sigma^* = log(\sigma)$ paso 3) obtener el
posterior no normalizado de theta\* en escala logaritmica paso 4)
obtener muestras de theta *paso 5) convertir las muestras de theta* en
muestras de theta
