...
plot_con_hist <- ggplot(datos_control, aes(x = gain, color = "#87CEEB"))+
...
plot_con_box <-ggplot(datos_control, aes(y = gain, color = "#87CEEB"))+
  geom_boxplot()+
  labs(y = "Gain")+
  theme_bw() +
  theme(
...
# Graficos descriptivos
plot_oz_hist <-ggplot(datos_oz, aes(x = gain, color = "#FFA07A"))+
  geom_histogram(bins = 22)+
  labs(y = "Frecuencia")+
  theme_bw() +
  theme(
...
plot_oz_box <-ggplot(datos_oz, aes(y = gain, color = "#FFA07A"))+
  geom_boxplot()+
  labs(y = "Gain")+
  theme_bw() +
  theme(
...
```{r,echo=FALSE, warning=FALSE, message=FALSE, fig.align = "center", fig.width = 7, fig.height = 3.5, fig.cap="Histograma y Boxplot para Ozono"}
