...
```{r f6,echo=FALSE, fig.align = "center", fig.width = 4, fig.height = 2.8, warning=FALSE, fig.cap="Traceplots con sigma = 1.3"}
# Grafica las 4 trazas
...
```{r f10,echo=FALSE, fig.align = "center", fig.width = 4, fig.height = 2.8, warning=FALSE, fig.cap="Traceplot de la muestras de X"}
graficar_traza(muestras_x, color = "#3b78b0")                           
```
...
```{r ,echo=FALSE, fig.align = "center", fig.width = 5, fig.height = 3.5, warning=FALSE, fig.cap="Traceplots con sigma = 0.12"}
set.seed(0398)
...
```{r f13,echo=FALSE, fig.align = "center", fig.width = 4, fig.height = 2.8, warning=FALSE, fig.cap="Traceplots con sigma = 0.12"}
...
```{r f15,echo=FALSE, fig.align = "center", fig.width = 4, fig.height = 2.8, warning=FALSE, fig.cap="Traceplots con sigma = 0.13"}
# Grafica las 4 trazas
df_muestras_sigma_trp <- df_muestras_sigma
df_muestras_sigma_trp[ ,3] <- exp(df_muestras_sigma[ ,3])
graficar_trazas_md(df_muestras_sigma_trp, ylab =TeX("$\\sigma$"), colors = c("#87CEEB", "#FFA07A", "#FFFFE0", "#B0E0E6"))
```
...
```{r f18, echo = FALSE, warning=FALSE, message=FALSE, fig.cap="Comparación de densidades: Normal vs t-Student (df=3)", fig.align = "center", fig.width = 4, fig.height = 2.8}
...
## Posteriors para $\mu$ y $\sigma$ en el grupo de ozono bajo un modelo normal
...
```{r f19,echo=FALSE, message=FALSE, fig.align = "center",  fig.width = 4, fig.height = 2.8, warning=FALSE, fig.cap="Histograma de la muestras de mu"}
#histograma que muestra la dist a posteriori marginal de mu
graficar_distribucion(
...
```{r f20,echo=FALSE, message=FALSE, fig.align = "center", fig.width = 4, fig.height = 2.8, warning=FALSE, fig.cap="Histograma de la muestras de sigma"}
#histograma que muestra la dist a posteriori marginal de sigma (transformamos sigma_estrella)
graficar_distribucion(
...
## Posteriors para $\mu$ y $\sigma$ en el grupo de control bajo un modelo normal
...
```{r f21,echo=FALSE, message=FALSE, fig.align = "center",  fig.width = 4, fig.height = 2.8, warning=FALSE, fig.cap="Histograma de la muestras de mu"}
#histograma que muestra la dist a posteriori marginal de mu
graficar_distribucion(
...
```{r f22,echo=FALSE, message=FALSE, fig.align = "center", fig.width = 4, fig.height = 2.8, warning=FALSE, fig.cap="Histograma de la muestras de sigma"}
#histograma que muestra la dist a posteriori marginal de sigma (transformamos sigma_estrella)
graficar_distribucion(
...
## Posteriors para $\mu$ y $\sigma$ en el grupo de ozono bajo un modelo t-student
...
```{r f23,echo=FALSE, message=FALSE, fig.align = "center",  fig.width = 4, fig.height = 2.8, warning=FALSE, fig.cap="Histograma de la muestras de mu"}
#histograma que muestra la dist a posteriori marginal de mu
graficar_distribucion(
  muestras_theta_estrella_oz[ ,1], #[1000:10000]
  x_grid = 1, #No podemos graficar la linea azul porq de antemano no conocemos la distribucion
...
```{r f24,echo=FALSE, message=FALSE, fig.align = "center", fig.width = 4, fig.height = 2.8, warning=FALSE, fig.cap="Histograma de la muestras de sigma"}
#histograma que muestra la dist a posteriori marginal de sigma (transformamos sigma_estrella)
graficar_distribucion(
  exp(muestras_theta_estrella_oz[ ,2]), #[1000:10000]burn-in (los quema a los primeros 1000 pasos)
...
```{r ,echo=FALSE, warning=FALSE, message=FALSE, fig.align = "center", fig.width = 4, fig.height = 2.8}
df_muestras_sigma_trp <- df_muestras_sigma
df_muestras_sigma_trp[ ,3] <- exp(df_muestras_sigma[ ,3])# se juntan las cadenas en una matriz para obtener las medidas de diagnostico
muestras_matriz <- matrix(df_muestras_sigma_trp$valor, ncol = n_cadenas, byrow = FALSE)
...
## Posteriors para $\mu$ y $\sigma$ en el grupo de control bajo un modelo t-student
...
```{r f25,echo=FALSE, message=FALSE, fig.align = "center",  fig.width = 4, fig.height = 2.8, warning=FALSE, fig.cap="Histograma de la muestras de mu"}
#histograma que muestra la dist a posteriori marginal de mu
graficar_distribucion(
  muestras_theta_estrella_c[ ,1], #[1000:10000]
  x_grid = 1, #No podemos graficar la linea azul porq de antemano no conocemos la distribucion
...
```{r f26,echo=FALSE, message=FALSE, fig.align = "center", fig.width = 4, fig.height = 2.8, warning=FALSE, fig.cap="Histograma de la muestras de sigma"}
#histograma que muestra la dist a posteriori marginal de sigma (transformamos sigma_estrella)
graficar_distribucion(
  exp(muestras_theta_estrella_c[ ,2]), #[1000:10000]burn-in (los quema a los primeros 1000 pasos)
  x_grid = 15, #No podemos graficar la linea azul porq de antemano no conocemos la distribucion
